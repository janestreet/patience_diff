(* OASIS_START *)
(* DO NOT EDIT (digest: fec898e3eefee3b1d8825e5f406f53d5) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/patience_diff";
          synopsis = "Library implementing patience diff";
          description = None;
          categories = [];
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("pa_pipebang", None);
                   ...
                   {
                      lib_modules = ["Patience_diff"; "Plain_diff"; "Std"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "patience_diff";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\135\1741\226!Y\004\159\006\137\245C\011\165Z\028";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
