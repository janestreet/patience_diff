(* OASIS_START *)
(* DO NOT EDIT (digest: 4f883f9459fb74112e61836ec06d010e) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          synopsis = "Tool and library implementing patience diff";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\172\130`#\1377|\240\1419\134Ut\141]\155";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
