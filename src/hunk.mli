...
[@@deriving fields ~getters, sexp_of, compare ~localize, equal ~localize]
...
module Stable : sig
  module V2 : sig
    type nonrec 'a t = 'a t [@@deriving sexp, bin_io, equal ~localize]
  end

  module V1 : sig
    type nonrec 'a t [@@deriving sexp, bin_io, equal ~localize]
